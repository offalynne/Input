...
if (input_game_has_focus())
{
    ...
    if (input_gamepad_check(_first_gamepad, gp_shoulderr))
    {
        _delta += input_gamepad_check_pressed(_first_gamepad, gp_padd) - input_gamepad_check_pressed(_first_gamepad, gp_padu);
    }
}
