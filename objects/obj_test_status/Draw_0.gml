...
if (_players_status.__any_changed) show_debug_message("Players: " + string(_players_status));

var _gamepads_status = input_gamepads_get_status();
if (_gamepads_status.__any_changed) show_debug_message("Gamepads: " + string(_gamepads_status));
