...
$" ",
$"InputGetHotswap() = {InputGetHotswap()}",
...
$" ",
$"Device 0 = {InputPlayerGetDevice(0)} \"{InputDeviceGetDescription(InputPlayerGetDevice(0))}\"",
$"Device 1 = {InputPlayerGetDevice(1)} \"{InputDeviceGetDescription(InputPlayerGetDevice(1))}\"",
$" ",
