...
if (input_source_using(INPUT_GAMEPAD, 0))
{
    ...
    _string += input_binding_get_icon(input_binding_get("pause", 0)) + " = Go Back\n";
}
else
{
    ...
    _string += "Mouse = Aim\n";
    _string += input_binding_get_icon(input_binding_get("shoot", 0)) + " = Shoot\n";
    _string += input_binding_get_icon(input_binding_get("pause", 0)) + " = Go Back\n";
}
...
{
    _string += input_binding_get_icon(input_binding_get("left", 1)) + "/" + input_binding_get_icon(input_binding_get("right", 1)) + "/" + input_binding_get_icon(input_binding_get("up", 1)) + "/" + input_binding_get_icon(input_binding_get("down", 1)) + " = Move\n";
    _string += input_binding_get_icon(input_binding_get("aim_left", 1)) + "/" + input_binding_get_icon(input_binding_get("aim_right", 1)) + "/" + input_binding_get_icon(input_binding_get("aim_up", 1)) + "/" + input_binding_get_icon(input_binding_get("aim_down", 1)) + " = Aim\n";
    _string += input_binding_get_icon(input_binding_get("shoot", 1, 0)) + "/" + input_binding_get_icon(input_binding_get("shoot", 1, 1)) + " = Shoot\n";
    _string += input_binding_get_icon(input_binding_get("pause", 1)) + " = Go Back\n";
}
else
{
    ...
    _string += "Mouse = Aim\n";
    _string += input_binding_get_icon(input_binding_get("shoot", 1)) + " = Shoot\n";
    _string += input_binding_get_icon(input_binding_get("pause", 1)) + " = Go Back\n";
}
