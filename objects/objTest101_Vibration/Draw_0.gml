...
_string += "\n";
_string += "supported = " + (InputVibrateGetSupported()? "true" : "false") + "\n";
_string += "paused = " + (InputVibrateGetPause()? "true" : "false") + "\n";
_string += "strength = " + string(InputVibrateGetStrength()) + "\n";
_string += "magnitude = " + string(InputVibrateGetMagnitude()) + "\n";
_string += "event count = " + string(InputVibrateGetEventCount()) + "\n";
_string += "\n";
