...
_string += "\n";
_string += concat("Recent x = ", input_x("left", "right", "up", "down", 0, true), "\n");
_string += concat("Recent y = ", input_y("left", "right", "up", "down", 0, true), "\n");
_string += concat("Recent xy = ", input_xy("left", "right", "up", "down", 0, true), "\n");
_string += concat("Recent direction = ", input_direction("left", "right", "up", "down", 0, true), "\n");
_string += concat("Recent distance = ", input_distance("left", "right", "up", "down", 0, true), "\n");
