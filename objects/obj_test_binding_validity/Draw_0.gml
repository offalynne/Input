...
_string += "\n" + "gamepad button south        " + string(input_binding_is_valid(input_binding_get("gamepad button south",        INPUT_SOURCE.GAMEPAD))) + _pad + string(input_check("gamepad button south"));
_string += "\n" + "gamepad trigger left        " + string(input_binding_is_valid(input_binding_get("gamepad trigger left",        INPUT_SOURCE.GAMEPAD))) + _pad + string(input_check("gamepad trigger left"));
_string += "\n" + "gamepad dpad up             " + string(input_binding_is_valid(input_binding_get("gamepad dpad up",             INPUT_SOURCE.GAMEPAD))) + _pad + string(input_check("gamepad dpad up"));

_string += "\n" + "invalid high gamepad axis   " + string(input_binding_is_valid(input_binding_get("invalid high gamepad axis", INPUT_SOURCE.GAMEPAD))) + _pad + string(input_check("invalid high gamepad axis"));
_string += "\n" + "invalid low gamepad axis    " + string(input_binding_is_valid(input_binding_get("invalid low gamepad axis",  INPUT_SOURCE.GAMEPAD))) + _pad + string(input_check("invalid low gamepad axis"));
_string += "\n" + "gamepad thumbstick left     " + string(input_binding_is_valid(input_binding_get("gamepad thumbstick left",   INPUT_SOURCE.GAMEPAD))) + _pad + string(input_check("gamepad thumbstick left"));
