...
- [`input_cursor_previous_x([playerIndex])`](Functions-(Cursor)?id=input_cursor_previous_xplayerindex)
- [`input_cursor_previous_y([playerIndex])`](Functions-(Cursor)?id=input_cursor_previous_yplayerindex)
