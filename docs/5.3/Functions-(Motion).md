...
<figure><img src="https://i.imgur.com/lCUmGHT.png" width="80%" style="display: block; margin: auto; max-width: 300px; height: auto;" /></figure>
...
```
{
    axis_x: <[`INPUT_GYRO` axis member](Library-Constants.md?id=Gyro-Axis) indicating world axis which controls cursor movement on the screen X axis>,
    axis_y: <[`INPUT_GYRO` axis member](Library-Constants.md?id=Gyro-Axis) indicating world axis which controls cursor movement on the screen Y axis>,
