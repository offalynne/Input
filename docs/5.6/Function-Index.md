...
- [`input_source_set(source, [playerIndex], [autoProfile], [exclusive])`](Functions-(Sources)?id=input_source_setsource-playerindex-autoprofile-exclusive)
- [`input_source_add(source, [playerIndex], [exclusive])`](Functions-(Sources)?id=input_source_addsource-playerindex-exclusive)
- [`input_source_share(source, arrayOfPlayerIndexes, [autoProfile], [exclusive])`](Functions-(Sources)?id=input_source_sharesource-playerindex-autoprofile-exclusive)
