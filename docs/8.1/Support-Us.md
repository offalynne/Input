...
- [GameMaker Kitchen](https://www.gamemakerkitchen.com/) admined by Input contribubtor [TabularElf](https://github.com/offalynne/Input/pulls?q=is%3Apr+author%3Atabularelf) is a resource community providing support for libraries including Input. You can [support TabularElf on Ko-fi](https://ko-fi.com/TabularElf)
