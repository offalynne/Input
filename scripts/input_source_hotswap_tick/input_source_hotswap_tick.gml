    ...
    if (global.__input_gamepad_default_defined)
    {
        ...
        repeat(gamepad_get_device_count())
        {
            if (gamepad_is_connected(_g) && input_source_is_available(INPUT_SOURCE.GAMEPAD, _g))
            {
                ...
                ||  (!input_gamepad_is_axis(_g, gp_shoulderlb) && input_gamepad_value(_g, gp_shoulderlb))
                ||  (!input_gamepad_is_axis(_g, gp_shoulderrb) && input_gamepad_value(_g, gp_shoulderrb))
