...
function __input_assignment_tick_input(_player_index)
{
    ...
    else if (global.__input_gamepad_valid)
    {
        ...
        repeat(gamepad_get_device_count())
        {
            ...
            {
                if (input_gamepad_button_check_pressed(_g, gp_face1)
                ||  input_gamepad_button_check_pressed(_g, gp_face2)
                ||  input_gamepad_button_check_pressed(_g, gp_face3)
                ||  input_gamepad_button_check_pressed(_g, gp_face4)
                ||  input_gamepad_button_check_pressed(_g, gp_padu)
                ||  input_gamepad_button_check_pressed(_g, gp_padd)
                ||  input_gamepad_button_check_pressed(_g, gp_padl)
                ||  input_gamepad_button_check_pressed(_g, gp_padr)
                ||  input_gamepad_button_check_pressed(_g, gp_shoulderl)
                ||  input_gamepad_button_check_pressed(_g, gp_shoulderr)
                ||  input_gamepad_button_check_pressed(_g, gp_shoulderlb)
                ||  input_gamepad_button_check_pressed(_g, gp_shoulderrb)
                ||  input_gamepad_button_check_pressed(_g, gp_start)
                ||  input_gamepad_button_check_pressed(_g, gp_select)
                ||  input_gamepad_button_check_pressed(_g, gp_stickl)
                ||  input_gamepad_button_check_pressed(_g, gp_stickr))
                {
