...
InputIconDefineGamepad(INPUT_GAMEPAD_TYPE_XBOX, gp_face1, "cross"   ); //Cross
InputIconDefineGamepad(INPUT_GAMEPAD_TYPE_XBOX, gp_face2, "circle"  ); //Circle
InputIconDefineGamepad(INPUT_GAMEPAD_TYPE_XBOX, gp_face3, "square"  ); //Square
InputIconDefineGamepad(INPUT_GAMEPAD_TYPE_XBOX, gp_face4, "triangle"); //Triangle
...
InputIconDefineGamepad(INPUT_GAMEPAD_TYPE_PS5, gp_select, "share"  ); //Select
InputIconDefineGamepad(INPUT_GAMEPAD_TYPE_PS5, gp_start,  "options"); //Start
