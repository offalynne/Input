        ...
        else
        {
            ...
            repeat(_gamepad_count)
            {
                ...
                { 
                    ...
                    ||  (input_gamepad_check_pressed(_g, gp_padu) && (abs(input_gamepad_delta(_g, gp_padu)) > 0))
                    ||  (input_gamepad_check_pressed(_g, gp_padd) && (abs(input_gamepad_delta(_g, gp_padd)) > 0))
                    ||  (input_gamepad_check_pressed(_g, gp_padl) && (abs(input_gamepad_delta(_g, gp_padl)) > 0))
                    ||  (input_gamepad_check_pressed(_g, gp_padr) && (abs(input_gamepad_delta(_g, gp_padr)) > 0))
