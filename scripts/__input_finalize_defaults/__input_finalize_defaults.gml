...
function __input_finalize_defaults()
{
    ...
    if (!variable_struct_exists(global.__input_basic_verb_dict, INPUT_CURSOR_VERB_UP   )) __input_trace("Warning! Default cursor up verb \"",    INPUT_CURSOR_VERB_UP,    "\" has not been defined for any profile");
    if (!variable_struct_exists(global.__input_basic_verb_dict, INPUT_CURSOR_VERB_DOWN )) __input_trace("Warning! Default cursor down verb \"",  INPUT_CURSOR_VERB_DOWN,  "\" has not been defined for any profile");
    if (!variable_struct_exists(global.__input_basic_verb_dict, INPUT_CURSOR_VERB_LEFT )) __input_trace("Warning! Default cursor left verb \"",  INPUT_CURSOR_VERB_LEFT,  "\" has not been defined for any profile");
    if (!variable_struct_exists(global.__input_basic_verb_dict, INPUT_CURSOR_VERB_RIGHT)) __input_trace("Warning! Default cursor right verb \"", INPUT_CURSOR_VERB_RIGHT, "\" has not been defined for any profile");
