/// @desc    Returns the change in the y-coordinate of the player's cursor (the difference between the current y-coordinate and that in the previous step)
...
function input_cursor_dy(_player_index = 0, _outputSystem = undefined)
{
    return input_cursor_y(_player_index, _outputSystem) - input_cursor_previous_y(_player_index, _outputSystem);
}