        ...
        switch(os_type)
        {
            ...
            case (os_linux):
                ...
                {                    
                    ...
                    if ((__global.__gamepads[__index].simple_type == "switch")
                    ||  (__global.__gamepads[__index].simple_type == "xbox 360") //Switch with "Use Nintendo Button Layout"
                    ||  (__global.__gamepads[__index].simple_type == "ps4"))
                    {
