...
function __input_gamepad_set_mapping()
{
    ...
    {
       __input_trace(false, "Setting Xbox One Wireless controller to alternate mapping. Trigger data unavailable.");
    ...
    if ((raw_type == "CommunityStadia") && __INPUT_ON_WINDOWS)
    {
       ...
       __input_trace(false, "Setting default Stadia controller mapping");
    ...
    if ((raw_type == "CommunityGameCube") && (vendor == "3412") && (product == "adbe") && __INPUT_ON_WINDOWS)
    {
       ...
       __input_trace(false, "Setting GameCube adapter slot to alternate mapping");
    ...
    if ((raw_type == "AppleController") && (guessed_type == false) && __INPUT_ON_WINDOWS)
    {
       ...
       __input_trace(false, "Setting MFi controller mapping");
    ...
    && (gamepad_get_mapping(index) == "no mapping") && __INPUT_ON_MACOS)
    {
       ...
       __input_trace(false, "Overriding from \"no mapping\" on Mac");
     ...
     || (__INPUT_ON_MACOS   && (button_count == 24) && (axis_count == 10) && (hat_count == 1))))
    {
       ...
       __input_trace(false, "Overriding mapping from Switch Pro to Joy-Con");
    ...
    if ((raw_type == "CommunityOuya") && __INPUT_ON_MACOS)
    {
       ...
       __input_trace(false, "Setting Ouya controller mapping");
    ...
    {
       __input_trace(false, "Overriding mapping to N64");        
    ...
    {
       __input_trace(false, "Overriding mapping to NeoGeo Mini");
    ...
    if ((vendor == "7e05") && (product == "1720") && (raw_type == "CommunitySaturn") && (guessed_type == false) && __INPUT_ON_LINUX)
    {
        ...
        {
           __input_trace(false, "Overriding mapping to Mega Drive 3b");
        ...
        {
           __input_trace(false, "Overriding mapping to Mega Drive 6b");
    ...
    if (__INPUT_ON_LINUX)
    {
        ...
        {            
            case "HIDJoyConLeft":
               __input_trace(false, "Overriding mapping to Joy-Con Left");
            ...
            case "HIDJoyConRight":
               __input_trace(false, "Overriding mapping to Joy-Con Right");
            ...
            case "HIDAtariVCSClassic":
               __input_trace(false, "Overriding mapping to Atari VCS Classic");
            ...
            case "HIDWiiRemote":
               __input_trace(false, "Overriding mapping to Wii Remote");
            ...
            case "HIDWiiClassic":            
               __input_trace(false, "Overriding mapping to Wii Classic");
    ...
    if (__INPUT_ON_ANDROID)
    {
        switch(guid)
        {
            ...
            case "484a5a204d6179666c61736820576969": //"HJZ Mayflash Wii"
                ...
                {
                   __input_trace(false, "Setting WiiU Pro Adapter mapping");
                ...
                {
                   __input_trace(false, "Setting DolphinBar mapping");
            ...
            case "64633735616665613536653363336132":
                ...
                {
                   __input_trace(false, "Setting Retroid Pocket \"Retro mode\" mapping");
                ...
                {
                   __input_trace(false, "Setting Retroid Pocket \"Xbox mode\" mapping");
    ...
    if (__INPUT_SDL2_SUPPORT && INPUT_SDL2_REMAPPING)
    {
        if (is_array(sdl2_definition))
        {
            ...
            repeat(array_length(sdl2_definition) - 3)
            {
                ...
                {
                   __input_trace(false, "Warning! Entry name \"", _entry_name, "\" not recognised (full string was \"", _entry, "\")");
                }
                else
                {
                    ...
                    do
                    {
                        ...
                        switch(_char)
                        {
                            ...
                            default:
                               __input_trace(false, "Warning! Mapping entry could not be parsed (full string was \"", _entry, "\")");
                            break;
                        }
                    }
                    ...
                    else
                    {
                        ...
                        {
                           __input_trace(false, "Warning! Mapping for \"", _entry, "\" is a redefinition of entry name \"", _entry_name, "\"");
                        }
                    ...
                    if (__INPUT_DEBUG) __input_trace(true, _entry_name, " = ", _raw_type, _entry_1);
                    ...
                    if ((_raw_type == __INPUT_MAPPING.AXIS) || (_raw_type == __INPUT_MAPPING.SPLIT_AXIS))
                    {
                        ...
                        {    
                            if (__INPUT_DEBUG) __input_trace(true, "  (Limited axis range)");
                            _mapping.limited_range = true;
                        }
                        else if (!__INPUT_ON_LINUX && !_is_directional && (gamepad_axis_count(index) >= _input_slot))
                        {
                            ...
                            if (__INPUT_DEBUG) __input_trace(true, "  (Extended axis range)");
            ...
            if (__INPUT_ON_ANDROID && (hat_count > 0) && (vendor + product == ""))
            {
                ...
                if (_matched == 4)
                {
                    ...
                    if (__INPUT_DEBUG) __input_trace(true, "  (Remapping dpad buttons to hat)");
                    set_mapping(gp_padu, 0, __INPUT_MAPPING.HAT, "dpup"   ).hat_mask = 1;
                    set_mapping(gp_padr, 0, __INPUT_MAPPING.HAT, "dpright").hat_mask = 2;
                    set_mapping(gp_padd, 0, __INPUT_MAPPING.HAT, "dpdown" ).hat_mask = 4;
                    set_mapping(gp_padl, 0, __INPUT_MAPPING.HAT, "dpleft" ).hat_mask = 8;
        ...
        {
           __input_trace(false, "No SDL2 remapping available, falling back to GameMaker's mapping (", gamepad_get_mapping(index), ")");
        }
        ...
        if (INPUT_SDL2_ALLOW_EXTENDED)
        {
            ...
            {                
                ...
                if (_matched == 4)
                {
                    ...
                    if (__INPUT_DEBUG) __input_trace(true, "  (Adding touchpad mapping)");
            ...
            if ((raw_type == "CommunityOuya") && (__INPUT_ON_WINDOWS || __INPUT_ON_LINUX))
            {
                ...
                if (__INPUT_DEBUG) __input_trace(true, "  (Remapping guide button)");
