...
#macro INPUT_TIMER_MILLISECONDS       false  //Set to true to use milliseconds instead of frames through the library (e.g. for input_check_*() functions)
...
#macro INPUT_CHORD_DEFAULT_TIME        4     //Default time limit between the first and last key press for chord activation
