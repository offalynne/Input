...
#macro INPUT_TOUCH_EDGE_DEADZONE  35   //Margin in pixels where gaining or losing a touch index does not produce "pressed" or "released". Prevents default behaviour of dragging on or off the device edge producing a "tap".
