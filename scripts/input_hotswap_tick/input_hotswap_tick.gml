...
function __input_hotswap_tick_input(_player_index)
{
    ...
    else if (global.__input_gamepad_valid)
    {
        ...
        repeat(gamepad_get_device_count())
        {
            ...
            {
                if (input_gamepad_button_check(_g, gp_face1)
                ||  input_gamepad_button_check(_g, gp_face2)
                ||  input_gamepad_button_check(_g, gp_face3)
                ||  input_gamepad_button_check(_g, gp_face4)
                ||  input_gamepad_button_check(_g, gp_padu)
                ||  input_gamepad_button_check(_g, gp_padd)
                ||  input_gamepad_button_check(_g, gp_padl)
                ||  input_gamepad_button_check(_g, gp_padr)
                ||  input_gamepad_button_check(_g, gp_shoulderl)
                ||  input_gamepad_button_check(_g, gp_shoulderr)
                ||  input_gamepad_button_check(_g, gp_shoulderlb)
                ||  input_gamepad_button_check(_g, gp_shoulderrb)
                ||  input_gamepad_button_check(_g, gp_start)
                ||  input_gamepad_button_check(_g, gp_select)
                ||  input_gamepad_button_check(_g, gp_stickl)
                ||  input_gamepad_button_check(_g, gp_stickr)
                ||  (INPUT_HOTSWAP_ON_GAMEPAD_AXIS && (abs(input_gamepad_axis_value(_g, gp_axislh)) > input_axis_threshold_get(gp_axislh, _player_index).mini))
                ||  (INPUT_HOTSWAP_ON_GAMEPAD_AXIS && (abs(input_gamepad_axis_value(_g, gp_axislv)) > input_axis_threshold_get(gp_axislv, _player_index).mini))
                ||  (INPUT_HOTSWAP_ON_GAMEPAD_AXIS && (abs(input_gamepad_axis_value(_g, gp_axisrh)) > input_axis_threshold_get(gp_axisrh, _player_index).mini))
                ||  (INPUT_HOTSWAP_ON_GAMEPAD_AXIS && (abs(input_gamepad_axis_value(_g, gp_axisrv)) > input_axis_threshold_get(gp_axisrv, _player_index).mini)))
                {
