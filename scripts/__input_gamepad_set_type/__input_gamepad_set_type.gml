...
function __input_gamepad_set_type()
{
    ...
    switch(os_type)
    {
        ...
        case os_operagx:
            if (__description == "Pro Controller (")
            {
                __raw_type = "SwitchProController";
                __guessed_type = false;
            }
            else if (__description == "Joy-Con L+R (STA")
            {
                __raw_type = "SwitchJoyConPair";
                __guessed_type = false;
            }
            else if (__description == "Wireless Control") //Sony PS4 and PS5 gamepads
            {
                __raw_type = "CommunityPS4";
                __guessed_type = true;
            }
            else if (__description == "Xbox 360 Control") //Any XInput gamepad
            {
        ...
        default:
            var _irregular_guid = (__vendor + __product == "");
            ...
            else if (variable_struct_exists(_global.__raw_type_dictionary, __vendor + __product))
            {
                __raw_type = _global.__raw_type_dictionary[$ __vendor + __product];
                __guessed_type = false;
            }
            else
            {
                ...
                if (!__INPUT_SILENT)
                {
                    ...
                    {
                        __input_trace("Warning! VID+PID \"", __vendor + __product, "\" not found in raw type database. Guessing controller type based on description = \"", __description, "\"");
                    }
                }
            ...
            if ((__vendor == "3412") && (__product == "adbe") && (__button_count == 12) && (__axis_count == 6) && (__hat_count == 0) && __INPUT_ON_WINDOWS)
            {
            ...
            else if ((__vendor == "0d00") && (__product == "0000") && (__button_count == 15) && (__axis_count == 4) && (__hat_count == 0) && __INPUT_ON_WINDOWS)
            {
            ...
            else if ((__vendor == "6325") && (__product == "7505") && (__INPUT_ON_WINDOWS || __INPUT_ON_LINUX))
            {
                ...
                {
                    if ((gamepad_get_description(__index) == "USB ") || (gamepad_get_description(__index) == "SWITCH CO.,LTD. Retro-bit Controller"))
                    {
                        ...
                        __raw_type = "CommunitySwitch";
                        __guessed_type = false;
                    }
                    else if (__input_string_contains(gamepad_get_description(__index), "Controller (Dinput)"))
                    {
            ...
            else if ((__vendor == "d904") && (__product == "93a2") && INPUT_ON_PC)
            {
                //Anne Pro 2
            ...
            else if (((__vendor == "8f0e") && (__product == "1330"))                                                                                         //HuiJia gamepad or Mayflash N64
            ...
            else if (((__vendor == "d620") || (__product == "10a7")) && (__hat_count == 0) && __INPUT_ON_WINDOWS                                              //MagicNS or Mayflash N64 Adapter
            ...
            else if ((string_pos("4a4a000000000000", __guid) == 1) && __INPUT_ON_ANDROID)
            {
                __raw_type = "CommunityNeoGeo";
                __guessed_type = true;
            }
