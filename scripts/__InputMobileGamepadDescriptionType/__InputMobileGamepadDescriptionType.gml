function __InputMobileGamepadDescriptionType(_description)
{
    ...
    else if (__InputStringContains(_description, "joy-con (l/r)", "for switch", "for nintendo switch", "switch controller", "switch pro", "lic pro", "mobapad", "8bitdo", "wii", "snes", "sfc"))
    {
